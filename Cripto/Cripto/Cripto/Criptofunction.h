...
namespace Cripto 
{
	...
	*/
	public:
		static  CRIPTOFDLL_API int init_ofb_14(unsigned char *key, void *ctx, size_t s, unsigned char *iv, size_t ivLength, printout_byte_array print, printout_uint_array print_uint);
	...
	*
	...
	return -1 если произошла ошибка
	*/
		static  CRIPTOFDLL_API void free_ofb(void* ctx);
	...
	return -1 если произошла ошибка
	*/
		static  CRIPTOFDLL_API int crypt_ofb(void *ctx, unsigned char *indata, unsigned char *outdata, size_t inlength);
	...
	return -1 если произошла ошибка
	*/
		static  CRIPTOFDLL_API int encrypt_ofb(void *ctx, unsigned char *indata, unsigned char *outdata, size_t inlength);
	...
	return -1 если произошла ошибка
	*/
		static CRIPTOFDLL_API int decrypt_ofb(void *ctx, unsigned char *indata, unsigned char *outdata, size_t inlength);
	...
	*/
		...
		static CRIPTOFDLL_API void Hesh(char *string, int hashtype, char* res);
};
}