...
// оспованно на стандартной реализации госта
/* Ќелинейное биективное преобразование множества двоичных векторов. */
static const unsigned char kPi[256] =//pi
{
...
/* ќбратное нелинейное биективное преобразование множества двоичных векторов. */
...
using namespace std;
/*  оэффициенты умножени€ в преобразовании l */
static const  unsigned char kB[16] = { 148, 32, 133, 16, 194, 192, 1, 251, 1, 192, 194, 16, 133, 32, 148, 1 };//L

int funcX(unsigned char* a, unsigned char* b, unsigned char* outdata, printout_byte_array print)
{
	unsigned int i;
...
int funcS(unsigned char* indata, unsigned char* outdata, printout_byte_array print)
{
	size_t i = 0;
...
int funcReverseS(unsigned char* indata, unsigned char*  outdata, printout_byte_array print)
{
	unsigned int i;
...
int funcR(unsigned char* indata, unsigned char* outdata, printout_byte_array print)
{
	size_t i;
	unsigned char sum = 0;
...
int funcReverseR(unsigned char* indata, unsigned char* outdata, printout_byte_array print)
{
...
int funcL(unsigned char* indata, unsigned char* outdata, printout_byte_array print)
{
	unsigned char tmp[16];
	int i = 0;
...
int  funcReverseL(unsigned char* indata, unsigned char* outdata, printout_byte_array print)
{
	unsigned char tmp[16];
	unsigned int i;
...
int   funcLSX(unsigned char* a, unsigned char* b, unsigned char* outdata, printout_byte_array print)
{
...
int funcReverseLSX(unsigned char* a, unsigned char* b, unsigned char* outdata, printout_byte_array print)
{
	unsigned char temp1[16];
	unsigned char temp2[16];
